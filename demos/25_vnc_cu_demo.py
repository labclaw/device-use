...
Tart VM: topspin-sequoia (ARD auth: admin/admin, VNC port 5900).
...
def step_run_command(vnc_addr: str, ai: OpenAI,
...
def main() -> int:
    ...
    ok = step_run_command(vnc_addr, ai,
        cmd="efp",
